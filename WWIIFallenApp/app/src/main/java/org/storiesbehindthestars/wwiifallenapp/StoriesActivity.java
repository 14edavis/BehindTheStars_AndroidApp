...
public class StoriesActivity extends AppCompatActivity implements StoriesPresenter.MVPView{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        testMemorial.setText(name, story);
        testMemorial.setOnClickListener((view)->{
            Intent intent = new Intent(this, StoryActivity.class);
            startActivity(intent);
        });

        //TODO: change later -- hard coded for testing
        MemorialView test2Memorial = new MemorialView(this, null,false);
        test2Memorial.setText(name, story);
        MemorialView test3Memorial = new MemorialView(this, null,false);
        test3Memorial.setText(name, story);
...
//        webView.loadUrl(urlToGoTo);
        ...
        mainLayout.addView(test2Memorial);
        mainLayout.addView(test3Memorial);
